...
export default function Cellier() {
    ...
    const [modalAjouteBoutteilAuCellier, setModalAjouteBoutteilAuCellier] =
        useState(false);
        ...
        },
        {
            ...
            render: (item) => {
                ...
                const deleteMethod = (idBouteille) => {
                    ...
                    axios
                        .delete(`/supprimerBouteille/${idBouteille}`)
                        .then((res) => {
                            // Récupérer les données, actualiser la page
                            console.log(res.data);
                            axios
                                .get("/getListeBouteilleCellier")
                                .then((res) => {
                                    setData(res.data);
                                });
                        });
    ...
    const ajouterBoutteilAuCeliierFormOk = () => {
        ajouteBoutteilAuCeliierForm.current.validateFields().then((value) => {
            console.log(value);
    ...
    return (
        ...
        <div>
            ...
            <div className="button-middle">
                <Button
                    type="primary"
                    onClick={() => setModalAjouteBoutteilAuCellier(id)}
                >
            ...
            >
                ...
                <Form ref={ajouteBoutteilAuCeliierForm} layout="vertical">
                    <p>
                        ...
                        >
                            <option value="0">
                                <i class="select-titre">Selectionnez le vin</i>
                            </option>
