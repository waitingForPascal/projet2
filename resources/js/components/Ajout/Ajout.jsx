        ...
        <div className="nouvelleBouteille" vertical layout>
            <Row gutter={[0, 16]}>
                <div>
                    ...
                    <p>
                        Pays : <b>{vinSelectioné.pays}</b>
                    </p>
                    <p>
                        Millesime :{" "}
                        <input
                            name="millesime"
                            value={vinSelectioné.millesime}
                        />
                    </p>
                    <p>
                        Quantite :{" "}
                    ...
                    <p>
                        ...
                        <input
                            name="date_achat"
                            type="date"
                            onChange={dateAchatChange}
                        />
                    </p>
                    <p>Prix : {vinSelectioné.prix} $</p>
                    <p>
                        Notes <input name="notes" value={vinSelectioné.note} />
                    </p>
                    <p>
                        <input type="hidden" name="cellier_id" value="1" />{" "}
                    </p>
                    <Button
                        type="primary"
            ...
            <>
                {vinSelectioné.id ? (
                    ...
                    <p>Choisissez une bouteiile S.V.P</p>
                )}
            </>
        </div>
    );
